  ...
  return (
    <div className='p-2 h-screen  flex flex-col justify-between '>
      ...
      className="flex flex-col p-5 justify-between ">
        ...
        <p className='text-center '> New Here? <Link to={'/user-signup'} className='text-center mb-3 text-blue-600'> Create new Accounts </Link></p>
      </form>
    </div>
    
      <div className='flex ml-8 pb-7 mr-8 '>
        <Link to={'/captain-login'} className="bg-green-500 flex item-center  justify-center items-center w-full px-4 py-2 text-black font-semibold rounded-xl border-2 text-lg border-black placeholder:text-base">
          Login as Captain
        </Link>
      </div>
    </div>
